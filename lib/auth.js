module.exports = {
  ...
  StatusUI(req, res) {
		...
		if (this.IsOwner(req, res)) {
			authStatusUI = `<button class="btn blue uppercase bold" onclick="">${req.user.displayName}</button> | 
											<button class="btn blue uppercase bold" onclick="location.href='/auth/logout';">로그아웃</button>
											<img style="margin-left: 10px" width="33px" src="public/images/bell-regular.svg" alt="">
											`;
		}
