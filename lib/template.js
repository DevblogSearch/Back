...
>>>>>>> 64d894c997025df298186758d2d27fc5df9be4ea
  ...
  parseSearchResponse(searchResponse, q, start, numFound, user) {
    let searchPage = `
<<<<<<< HEAD
      <div class="row">
...
=======
      ...
      <div class="col-xs-11 col-sm-11 col-md-6 col-md-offset-1 col-lg-5 col-lg-offset-1">
>>>>>>> 64d894c997025df298186758d2d27fc5df9be4ea
    `
    ...
    for (res of searchResponse) {
      let likeButton = '';
      let cancelLikeButton = '';

      if (!!user) {
<<<<<<< HEAD
        likeButton = `<button class = "button-like" onclick="likeEvent(${user.id}, '${res.url}')"><i class="fa fa-heart"></i><span>like</span></button>`;
        // likeButton = '<button type="button" onclick="likeEvent()">Like Me!</button>'
        // likeButton = "<div id='heart' class='button'></div>";
=======
        likeButton = `<button type="button" onclick="likeEvent(${user.id}, '${res.url}')">Like Me!</button>`;
        cancelLikeButton = `<button type="button" onclick="cancelLikeEvent(${user.id}, '${res.url}')">Cancel Like!</button>`;
>>>>>>> 64d894c997025df298186758d2d27fc5df9be4ea
      }
      ...
      <li class="search-item clearfix">
        <div class="search-content text-left">
          <a href="${res.url}" ping="https://hangoole.com/events/ping?url=${res.url}&blog_id=${res.blog_id}">
